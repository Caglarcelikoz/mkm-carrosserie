          ...
          {showHeader && (
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                helpen u graag verder met al uw carrosseriewerken.
              </p>
            </div>
          )}
                  ...
                  <div>
                    ...
                    <div className="w-full h-48 rounded-lg overflow-hidden border border-border">
                      <iframe
                        ...
                        title="MKM Carrosserie Locatie - Toekomstlaan 13, 3600 Genk"
                      />
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="lakwerk">Lakwerk</option>
                      <option value="carrosserie">Carrosseriewerken</option>
